...
//             return "No";
//         }else if(cards1.indexOf(goal[i]) >= 0){
//             if(check_1 < cards1.indexOf(goal[i])){
//                 check_1 = cards1.indexOf(goal[i]);
//                 continue;
//             }else{
//                 return "No";
//             }
//         }else if(cards2.indexOf(goal[i]) >= 0){
//             if(check_2 < cards2.indexOf(goal[i])){
//                 check_2 = cards2.indexOf(goal[i]);
//                 continue;
//             }else{
//                 return "No";
//             }
